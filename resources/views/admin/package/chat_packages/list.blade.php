...
<aside class="right-side">                
  ...
  <section class="content-header">
   ...
   <ol class="breadcrumb">
    ...
    <li class="active">Chat Packages</li>
  </ol>
</section>
          ...
          <table class="table table-advance" >
           ...
           <!--   <th ><input type="text" placeholder="Enter Name" name="first_name" value=""></th> 
              ...
              {{--<th><span style="float: right;">
                <a href="{{url('admin/add-chat-package')}}" class="btn btn-default">Add New</a>
          ...
          <thead>
            ...
            <tbody id="rowbody">
             ...
             <tr>
              ...
              <td>
                <a title="Edit" href="{!! url('admin/chat-packages/edit-chat-package',[$country->id]) !!}">
    ...
    for(var i=0;i<formRef.elements.length;i++)
    {
      ...
      {     
        $.ajax({
          ...
          url: "../admin/updatechatpackagestatus",
        ...
        for(i=0;i<element_lenght;i++)
        {
         if(country.elements[i].name=="mul_del[]")
         {
          if(country.elements[i].checked==true)
          {
           ...
           {
             $("#country").attr("action", "{{url('admin/deleteallchatpackages')}}");
             this.country.submit();
             break;
           }
         }	
