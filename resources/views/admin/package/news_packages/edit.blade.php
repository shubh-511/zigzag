    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form name="form" action=" {{ url('admin/editnews_package',[$package->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="access" name="access"  placeholder="1 for unlimited access" required value="{{ $package->access}}">
                    </div>
