...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('admin/news-packages')}}">Package</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="box box-primary">
               ...
               <!-- form start -->
               <form name="form" action=" {{ url('admin/save_newspackage') }}" method="post"  enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail">Article Access (How many articles you want to post with this package)</label>
                        <input type="text" class="form-control" id="access" name="access"  placeholder="1 for unlimited access" required value="<?php echo   isset($row)? $row['access'] : ''?>">
                    </div>
