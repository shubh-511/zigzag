    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form name="form" action=" {{ url('admin/editpackage',[$package->id]) }}" method="post" enctype="multipart/form-data">


                <div class="box-body">
                    
                    <div class="form-group">
    <label for="Parent customer">Select Upgrade Type</label>
    <select class="form-control" name="upgrade_id" required>
    <option value=''>--Select Type--</option>
    
    @foreach($upgrades as $country)
        @if($package->upgrade_id==$country->id)
    	   <option value="{{$country->id}}" selected="true">{{    $country->title}}</option>
        @else
