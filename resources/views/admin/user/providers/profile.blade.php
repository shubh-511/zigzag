  ...
  <section class="content-header">
    <h1>Profile #: {{$user->name}}</h1>
     <ol class="breadcrumb">
      ...
      <li><a href="{{ url('admin/service-provider')}}">Service Provider</a>
      </li>
...
<form id="user" name="user" action="" method="post">
    <div class="box-body table-responsive">
		...
		<div class="col-md-6">            
            <div class="form-group">
                ...
                <label for="exampleInputEmail" class="form-control" class="form-control" @if($user->admin_approval=='0') style="background-color:#eb643c; color:white" @else style="background-color:#3CB371;color:white" @endif>@if($user->admin_approval==1) {{'Verified'}} @else {{'Pending'}} @endif</label>
			</div>
		</div>
		<!--<div class="col-md-6">            
            <div class="form-group">
   ...
   <div class="box-footer" style="float:right">
       <a href="{{ url('admin/service-provider')}}" class="btn btn-primary">Back</a>
