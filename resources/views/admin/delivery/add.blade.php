...
<div class="row">
    ...
    <!-- general form elements -->
        ...
        <!-- form start -->
        <form role="form" action="{{ url('admin/savecharge')}}" method="post" enctype="multipart/form-data">
                <div class="box-body">
                ...
                <input type="text" class="form-control" id="from_distance" name="from_distance" placeholder="Distance from" required>
                </div>
				<div class="form-group">
                <label for="exampleInputEmail1">Distance to(Miles)</label>
                <input type="number" class="form-control" value="0.00" id="to_distance" name="to_distance" placeholder="Minimum Order Price" required>
                </div>
				<div class="form-group">
                <label for="exampleInputEmail1">Charge ($)</label>
                <input type="number" class="form-control" value="0.00" id="charges" name="charges" placeholder="Charges" min="0" max="1000" step=".01"  required>
                </div>
