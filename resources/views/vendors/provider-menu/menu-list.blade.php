           ...
           <div class="box">
            <div class="box-header" style="float: left; width: 100%;">
			 ...
			 @if($success = Session::get('success'))
               <div class="alert alert-success">
			   <span class="glyphicon glyphicon-ok "></span><em> {{ $success }}</em>             
                </div>
             @endif
             ...
             <form name="form2" id="form2" method="get" action="" class="form-horizontal">
              <table class="table table-advance">
                <tr>                
                   <th> <span style="float: right;"><a href="{{ route('provider-menu.create') }}" class="btn btn-default">Add New</a>
              ...
              <tbody id="rowbody">
                ...
                <tr>
                    <th scope="col"><input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        ...
                        <td><img style="width:50px;" src="{{ asset($menu->menu_icon) }}"></img></td>
						<td>                            
                        ...
                        <td> <a title="Edit" href="{{ route('provider-menu.edit',$menu->id) }} "><i class="fa fa-pencil"></i></a> </td>                        
                    </tr>
                    @endforeach
                </tbody> 
            </table>  
...
<script type="text/javascript">
    ...
    {     
        $.ajax({
            ...
            url: "{{ url('provider-menu/updateprovidermenustatus') }}",
        ...
        for(i=0;i<element_lenght;i++)
        {
            if(menu.elements[i].name=="mul_del[]")
            {
                if(menu.elements[i].checked==true)
                {
                    ...
                    {
                        $("#menu").attr("action", "{{url('provider-menu/deleteallprovidermenu')}}");
                        this.menu.submit();
                        break;
                    }
                }   
