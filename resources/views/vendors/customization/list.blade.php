            ...
            <div class="box-header" style="float: left; width: 100%;">
             ...
             <form name="form2" id="form2" method="get" action="" class="form-horizontal">
              <table class="table table-advance">
                <tr>                
                   <th> <span style="float: right;"><a href="{{ route('customization.create') }}" class="btn btn-default">Add New</a>
              ...
              <tbody id="rowbody">
                ...
                <tr>
                    <th scope="col"><input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                        ...
                        <td> <a title="Edit" href="{{ route('customization.edit',$menu->id) }} "><i class="fa fa-pencil"></i></a> </td>                        
                    </tr>
                    @endforeach
                </tbody> 
            </table>  
...
<script type="text/javascript">
    ...
    {     
        $.ajax({
            ...
            url: "{{ url('customization/updatecustomizationstatus') }}",
        ...
        for(i=0;i<element_lenght;i++)
        {
            if(menu.elements[i].name=="mul_del[]")
            {
                if(menu.elements[i].checked==true)
                {
                    ...
                    {
                        $("#menu").attr("action", "{{url('customization/deleteallcustomization')}}");
                        this.menu.submit();
                        break;
                    }
                }   
